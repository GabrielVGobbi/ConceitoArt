...
$(function() {
    ...
    var objeto = 1;
    $('.new_objeto').on('click', function(e) {

        e.preventDefault();
        var objeto2 = parseInt(objeto) + parseInt(1);

        var objeto_lote = "[lote][]";
        var objeto_quantia = "[quantia][]";
        var objeto_descricao = "[descricao][]";

        html = '<div class="col-md-2"><div class="form-group"><label>Nº Lote</label><input type="text" class="form-control" name="objeto' + objeto_lote + '" id="objeto' + objeto_lote + '" value=""></div></div>';
        html += '<div class="col-md-6"><div class="form-group"><label>Descrição</label><input type="text" class="form-control" name="objeto' + objeto_descricao + '"" id="objeto' + objeto_descricao + '"" value=""></div></div>';
        html += '<div class="col-md-4"><div class="form-group"><label>Quantia</label><div class="input-group"><input type="text" class="form-control" id="objeto' + objeto_quantia + '"" name="objeto' + objeto_quantia + '"" required><div class="input-group-addon"><i class="">R$</i></div></div> </div></div>';

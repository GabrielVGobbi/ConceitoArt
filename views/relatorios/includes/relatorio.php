					...
					<div class="box box-default color-palette-box">
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-md-4">
									<label for="fl_art_nome">Ordem</label>
									<div class="form-group">
										<select class="form-control select2" style="width: 100%;" name="filtros[ordem]" id="filtros[ordem]">
											<option value="art.art_nome">Artista</option>
											<option value="sit.id_situacao">Situação</option>
											<option value="inv.id_inventario">ID Obra</option>
											<option value="sit.codigo">Codigo</option>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="checkbox">
											<input type="checkbox" name="filtros[editM]" value="true">
										</div>
									</div>
								</div>
							</div>

...
<?php include("modalCadastrar.php"); ?>
        ...
        <div class="box-header" style="margin-bottom: 10px;">
            ...
            <div class="box-tools pull-right">
                <div class="has-feedback">
                    <a href="<?php echo BASE_URL;?>mercadolivre" type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
                ...
                <div class="box-footer no-padding">
                    <div class="mailbox-controls">
                        ...
                        <ul class="pagination pagination-sm pull-right">
                            <?php 
                            for($q=1;$q<=$p_count;$q++): ?>
                                <li class="<?php echo ($q==$p)?'active':'' ?> "><a href="<?php echo BASE_URL; ?>mercadolivre?p=<?php 
                                $w = $_GET;
                                $w['p'] = $q;

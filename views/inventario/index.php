                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr <?php if ($inv['inv_venda'] == '1') {
                                    ...
                                    } elseif (isset($inv['historico']) && $inv['retirada'] == '') {
                            ...
                            <td><?php echo ($inv['inv_venda'] == '1') ? '<span class="label label-danger">Vendido</span>' : '<span class="label label-success">Não Vendido</span>' ?> <?php echo ($inv['id_inv_situacao'] == '1') ? '<span class="label label-warning">Mercado Livre</span>' : '' ?> 
                                <?php controller::getLeilaoON($inv['id_inventario']); ?>
                            </td>
                        </tr>

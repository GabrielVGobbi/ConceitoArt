...
<?php elseif (isset($img['url']) && $img['url'] != '') : ?>
	<?php if($excluirFoto == true): ?>



		<div class="pull-right" data-toggle="popover" title="" data-content="<a  href='<?php echo BASE_URL; ?>fotos/delete/<?php echo $img['id_image'];?>' class='btn btn-danger'>Sim</a> <button type='button' class='btn btn-default pop-hide'>Não</button>" data-original-title="Remover Foto?" aria-describedby="popover712901">
